...
public class Controller {
    ...
    public static final String REGEX_CITY = "[A-Z][a-z]{1,20}|[А-ЩЬЮЯЇІЄҐ][а-щьюяїієґ]{1,20}";
    public static final String REGEX_STREET = "[A-Z][a-z]{1,20}|[А-ЩЬЮЯЇІЄҐ][а-щьюяїієґ]{1,20}";
    ...
    public static final String REGEX_DATE = "(([1-9]|[0-2]?[0-9])|(3[0-1]))\\.([1-9]|0[0-9]?|1[0-2])\\.([0-9][0-9])?[0-9][0-9]$";
